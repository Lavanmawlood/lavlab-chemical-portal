...
# ئەم دێڕانە بۆ ڕێگریکردنە لەوەی ستریمڵایت هەوڵبدات فایل لەسەر دیسک بنووسێت
os.environ["STREAMLIT_SERVER_FILE_WATCHER_TYPE"] = "none"
os.environ["STREAMLIT_BROWSER_GATHER_USAGE_STATS"] = "false"

# ڕێکخستنی سەرەتایی لاپەڕەکە (دەبێت یەکەم بڕگەی ستریمڵایت بێت)
st.set_page_config(
...
# بەکارهێنانی caching بۆ خێراکردنی پەیوەندی و پاراستنی ڕێسۆرسەکان
@st.cache_resource
def get_mongo_client(uri):
    ...
    try:
        ...
        client.server_info() # تاقیکردنەوەی چالاکبوونی بەستەر
        return client
    except Exception:
        return None
